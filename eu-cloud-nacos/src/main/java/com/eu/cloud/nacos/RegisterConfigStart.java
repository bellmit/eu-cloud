...
public class RegisterConfigStart {
    ...
    public static void main(String[] args) {
        ...
        if (osName.contains("Mac") || osName.contains("Linux")) {
            cmd = "sh " + resource.replace("file:", "") + "bin/startup.sh -m standalone";
        } else if (osName.contains("Windows")) {
            cmd = "cmd.exe /c " + resource.replace("file:/", "") + "bin/startup.cmd -m standalone";
        } else {
            System.exit(1);
        }

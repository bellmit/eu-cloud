package com.eu.cloud.es;

import com.eu.cloud.core.exception.GlobalException;
import com.eu.cloud.core.exception.GlobalExceptionCode;
import com.eu.cloud.es.bo.DateQueryBo;
import com.eu.cloud.es.bo.IndexBo;
import com.eu.cloud.es.bo.QueryBo;
import com.eu.cloud.es.bo.SortBo;
...
public class ElasticSearchClient {
    ...
    public ElasticSearchClient() {
        ...
        if (this.esNodes != null) {
            ...
            Optional<String[]> nodesHostArrO = Optional.of(this.esNodes.split(","));
     ...
     * @throws IOException
     */
    public SearchResponse fullSearch(String[] indexs, String content, int from, int size, List<SortBo> sortList, String aosId) throws IOException {
        ...
        try {
            ...
            if (sortList != null && sortList.size() > 0) {
                for (SortBo sortBo : sortList) {
                    searchSourceBuilder.sort(sortBo.getField(), SortOrder.fromString(sortBo.getSort()));
                }
            }
            if (size != 0 && size != 0) {
                if (from > 1) {

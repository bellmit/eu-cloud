...
/**
 * Gson工具类
 * 实际转换对象中存在null属性时，转换出来的JSON字符串将不会保留该属性
 *
 * @author jiangxd
 */
public class GsonUtil {
     ...
     * @return
     */
    public static <T> T getObject(String json, Class<T> classOfT, String pattern) {
        return new GsonBuilder().setDateFormat(pattern).create().fromJson(json, classOfT);
    }

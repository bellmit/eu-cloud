...
import com.eu.cloud.redis.annotation.ELock;
import com.eu.cloud.redis.annotation.ERepeat;
...
public class LockService {
     ...
     * 模拟秒杀(注解方式)
     */
    @ELock(lockKey = "#productId", expireSeconds = 5000)
     ...
     * 测试重复提交
     */
    @ERepeat(lockKey = "#name", lockTime = 5)
